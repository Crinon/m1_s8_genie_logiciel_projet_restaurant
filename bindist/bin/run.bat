...
%JAVACMD% %JAVA_OPTS% --module-path %JAVAFX_HOME%/lib -classpath %CLASSPATH% -Dapp.name="run" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" fr.ul.miage.restaurant.Main %CMD_LINE_ARGS%
