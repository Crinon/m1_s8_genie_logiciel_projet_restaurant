...
ALTER TABLE restaurant.affectation OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.affectation_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.assistant OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.assistant_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.commande OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.commande_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.cuisinier OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.cuisinier_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.directeur OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.directeur_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.etage OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.etage_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.ingredient OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.ingredient_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.maitrehotel OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.maitrehotel_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.personne OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.personne_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.plat OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.plat_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.recette OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.recette_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.reservation OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.reservation_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.restaurant OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.restaurant_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.serveur OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.serveur_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE restaurant.tables OWNER TO restaurant_user;
   ...
   --
CREATE SEQUENCE restaurant.tables_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
SELECT
                                                ...
                                                --
ALTER TABLE ONLY restaurant.affectation ADD CONSTRAINT affectation_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: assistant assistant_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.assistant ADD CONSTRAINT assistant_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: commande commande_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.commande ADD CONSTRAINT commande_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: cuisinier cuisinier_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.cuisinier ADD CONSTRAINT cuisinier_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: directeur directeur_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.directeur ADD CONSTRAINT directeur_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: etage etage_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.etage ADD CONSTRAINT etage_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: ingredient ingredient_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.ingredient ADD CONSTRAINT ingredient_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: maitrehotel maitrehotel_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.maitrehotel ADD CONSTRAINT maitrehotel_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: personne personne_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.personne ADD CONSTRAINT personne_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: plat plat_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.plat ADD CONSTRAINT plat_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: recette recette_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.recette ADD CONSTRAINT recette_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: reservation reservation_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.reservation ADD CONSTRAINT reservation_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: restaurant restaurant_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.restaurant ADD CONSTRAINT restaurant_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: serveur serveur_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.serveur ADD CONSTRAINT serveur_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: tables tables_pkey; Type: CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.tables ADD CONSTRAINT tables_pkey PRIMARY KEY (id);
                                                --
                                                -- Name: assistant assistant_personne_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.assistant ADD CONSTRAINT assistant_personne_fkey FOREIGN KEY (personne) REFERENCES restaurant.personne (id);
                                                --
                                                -- Name: commande commande_affectation_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.commande ADD CONSTRAINT commande_affectation_fkey FOREIGN KEY (affectation) REFERENCES restaurant.affectation (id);
                                                --
                                                -- Name: commande commande_plat_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.commande ADD CONSTRAINT commande_plat_fkey FOREIGN KEY (plat) REFERENCES restaurant.plat (id);
                                                --
                                                -- Name: cuisinier cuisinier_personne_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.cuisinier ADD CONSTRAINT cuisinier_personne_fkey FOREIGN KEY (personne) REFERENCES restaurant.personne (id);
                                                --
                                                -- Name: directeur directeur_personne_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.directeur ADD CONSTRAINT directeur_personne_fkey FOREIGN KEY (personne) REFERENCES restaurant.personne (id);
                                                --
                                                -- Name: maitrehotel maitrehotel_personne_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.maitrehotel ADD CONSTRAINT maitrehotel_personne_fkey FOREIGN KEY (personne) REFERENCES restaurant.personne (id);
                                                --
                                                -- Name: recette recette_ingredient_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.recette ADD CONSTRAINT recette_ingredient_fkey FOREIGN KEY (ingredient) REFERENCES restaurant.ingredient (id);
                                                --
                                                -- Name: recette recette_plat_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.recette ADD CONSTRAINT recette_plat_fkey FOREIGN KEY (plat) REFERENCES restaurant.plat (id);
                                                --
                                                -- Name: reservation reservation_tablereserve_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.reservation ADD CONSTRAINT reservation_tablereserve_fkey FOREIGN KEY (tablereserve) REFERENCES restaurant.tables (id);
                                                --
                                                -- Name: tables tables_etage_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.tables ADD CONSTRAINT tables_etage_fkey FOREIGN KEY (etage) REFERENCES restaurant.etage (id);
                                                --
                                                -- Name: tables tables_serveur_fkey; Type: FK CONSTRAINT; Schema: restaurant; Owner: restaurant_user
                                                --
ALTER TABLE ONLY restaurant.tables ADD CONSTRAINT tables_serveur_fkey FOREIGN KEY (serveur) REFERENCES restaurant.serveur (id);
                                                --
...
restaurant.serveur,
restaurant.tables RESTART IDENTITY;